...
void TMVAClassification( TString myMethodList = "" )
{
   ...
   // read training and test data
      ...
      TString fname1 = "/home/jzalieck/data/results/Run_Electron_5GeV.root";
      TString fname2 = "/home/jzalieck/data/results/Run_Pion_5GeV.root";
      ...
      std::cout << "--- TMVAClassification       : Using input file 1: " << input1->GetName() << std::endl;
      ...
      Double_t backgroundWeight = 0.0397;
