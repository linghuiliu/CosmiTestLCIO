...
#ifndef TBSD_VCellecal4d_h
#define TBSD_VCellecal4d_h 1
...
class TBSD_VCellecal4d : public VSensitiveDetector
{

public:

  TBSD_VCellecal4d(G4String sdname,   // name of SD
	       VSubDetectorDriver* this_detector,
	       G4double *gridsize, //Size of the EBU grid
	       ...
	       G4int applyBirksLawTemp=0, //flag to apply Birks law for ECAL
	       G4double ecalTimeCutTemp=0,//ECAL time cut (in ns)
	       G4double zBeginDetectorTemp=0);//temporary variable to store z-start of the ECAL detector
...
public:
  ...
  void SetGridSize(G4double* gridsize);
...
private:
  ...
  G4int cellID[3];
    ...
    /******************************************************************************/
   //z-start of the ECAL detector (in mm)
    G4double zBeginDetector;
    G4double ecalTimeCut;
    G4int applyBirksLaw;
