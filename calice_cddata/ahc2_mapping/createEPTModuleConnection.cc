...
int main(int argc, char** argv ) {
  ...
  try {
    ...
    lcio::LCTime end(2015, 8, 31, 0, 0, 0);//June2015
    //lcio::LCTime beginRun(2012, 1, 1, 0, 0, 0);
    //lcio::LCTime endRun(2014, 1, 31, 0, 0, 0);
    lcio::LCTime farFuture(2019, 1, 31, 23, 59, 59);
	...
	module_type = 0;//Module Mainz, ITEP 11, ITEP 10, 9, 8, 7, 6, 5
      if(ilayer >= 12)
	module_type = 2;//Module 12, 13, 14, 15
